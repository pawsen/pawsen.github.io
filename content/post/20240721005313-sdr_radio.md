...
## stl_sdr dongle info <span class="tag"><span class="ATTACH">ATTACH</span></span> {#stl-sdr-dongle-info}

The RTL-SDR is an cheap software defined radio receiver-dongle based on [DVB-T TV tuners with RTL2832U chips.](https://osmocom.org/projects/rtl-sdr/wiki/Rtl-sdr#Specifications%20)
...
[Hardware](https://www.pa3fwm.nl/technotes/tn20.html)
...
{{< figure src="/home/paw/tmp/notes/notes/tn20fig1.png" caption="<span class=\"figure-number\">Figure 1: </span>block diagram for RTL2832U with different tuners. RTL-SDR blog V4 is shown in b)" >}}
...
## Brief into to audio formats {#brief-into-to-audio-formats}
...
## Stream raw radio {#stream-raw-radio}


### using rtl_fm {#using-rtl-fm}
...
#### UHF / walkie talkie <span class="tag"><span class="ATTACH">ATTACH</span></span> {#uhf-walkie-talkie}

![](/home/paw/tmp/notes/notes/IMG20240925154924.jpg)
In Europe the frequencies are defined in [PMR446](https://en.wikipedia.org/wiki/PMR446). Analogue PMR446 uses 16 FM channels separated by 12.5 kHz.
...
Continuous Tone-Coded Squelch System (CTCSS) is a low continuous tone transmitted along with the voice. In CTCSS mode, the receiver only unmutes when the signal also carries the correct sub-audible audio tone. All users with different CTCSS tones on the same channel are still transmitting on the identical radio frequency. [CTSCC tones](https://www.sigidwiki.com/wiki/CTCSS#Additional_Images) and further info.
...
[recording of channel3 signal](/home/paw/tmp/notes/notes/channel3.wav)

![](/home/paw/tmp/notes/notes/channel3_spectrum.png)
...
{{< figure src="/home/paw/tmp/notes/notes/channel3_waterfall2.png" caption="<span class=\"figure-number\">Figure 4: </span>waterfall from SDR++" >}}
...
### Convert IQ samples to audio {#convert-iq-samples-to-audio}
...
### using rtl_power {#using-rtl-power}
