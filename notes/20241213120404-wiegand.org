...
:DIR:      ~/git/notes/.attach/notes-wiegand
:END:
#+title: wiegand
...
[[https://youtu.be/0NCnjx5wuns][Behind Closed Doors - Bypassing RFID Readers]], a presentation using [[*The Tick, ESP32 C3 based]] to read the wiegand data.
...
** doorsim / opendoorsim
[[https://github.com/evildaemond/doorsim][doorsim]] is a esp32 based access simulator and a [[https://github.com/nechry/DoorSim][refactored version using platformIO]]

There is  newer fork/clone, [[https://github.com/shortrangetech/opendoorsim/][Opendoorsim]]
** libraries
