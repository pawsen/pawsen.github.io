...
#+HUGO_CUSTOM_FRONT_MATTER: :summary "Make a angle-sensor(using an LCD, accelerometer and arduino) to show the angle of a Kilterboard"
...
#+CAPTION: Dispay and sensor, connected by I2C. Power input is the black cable going to the sensor-case (resting against the laptop bag).
