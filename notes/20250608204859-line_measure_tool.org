...
:link-img:   ../.atatch/pg-line-measurement-tool/diy-line-measurement-tool-domi*.jpg
:END:
...
- [[https://www.thingiverse.com/thing:5984533][LEICA Sock for Line Measuring Rig]], stl. Might fit a Bosch laser meter as well. ::
...
[[https://www.flybgd.com/en/paragliders/inspection-recommendations-13-0-0.html][BGDs Inspection Recommendations]]
...
#+begin_quote
The measured lengths of individual lines should match those in the line-lengths table within a +/-10mm tolerance.

An offset of +/-50mm of the line-lengths table is acceptable. That is to say, the entire line set can be longer or shorter up to a maximum value of 50mm.
#+end_quote
...
#+end_quote
* Other designs :ATTACH:

#+CAPTION: Tool using long rails. https://www.thingiverse.com/thing:6827738.
[[attachment:line-measument-tool-alternative-1.jpeg]]

#+CAPTION: Inspiration for the above, using wood profiles instead of rails. https://www.thingiverse.com/thing:6116049
[[attachment:line-measument-tool-alternative-2.jpeg]]

#+CAPTION: 3d printed boot for laser meter
[[attachment:laser-measurement-boot.jpg]]


#+CAPTION: Tool made by Domi, Zermatt
#+begin_export hugo
{{< gallery match="diy-line-measurement-tool-domi*.jpg" id="domi-tool" >}}
#+end_export
