...
[[attachment:diy-10s4p-battery.jpg]]
...
[[attachment:Anderson_SB50_Colour_Keying.jpg]]
...
[[attachment:DC_wire_selection_chartlg.jpg]]
...
[[attachment:nickel-plated-pure-nickel-salt-water.jpg]]
...
** Cutting copper, rounded corners :ATTACH:
- Crop-A-Dile Corner Chomper Punch, https://amzn.to/4hZRcFy
- Use a 3d-printed jig and a scissor/standley knife

#+CAPTION: 3d printed jig for cutting copper sheets with a scissor
[[attachment:3d-jig-rounded-corners.jpeg]]

* Cells
** Types
There are many different li-ion type cells
#+CAPTION: Different types of LI-ION cells
[[attachment:different-liion-cells.png]]
...
- [[https://www.aliexpress.com/item/1005001869928390.html][21700 Lithium Battery Packs DIY Misalignment Fixed Bracket Assembly Holder]]
** Voltage
...
[[attachment:cells-harvesting-flow-chart.jpeg]]
...
[[attachment:ac-dc-IR.jpg]]

#+CAPTION: SOH vs AC & DC IR
[[attachment:soh-vs-ac-dc-IR.jpg]]
...
[[attachment:BatteryChargePercent.png]]
...
* Tools
** Soldering iron
- [[https://geeboontools.aliexpress.com/store/1103439446/pages/all-items.html][Geeboon]] makes good digital soldering irons. ::
  The [[https://www.aliexpress.com/item/1005008060887226.html][HC24 soldering iron]] can run c210 up to c470 tips. With c470 tips it pulls 400w.
** AC IR
A good AC IR meter is *FNIRSI HRM-10*
** Spot Welder
[[https://youtu.be/TZr1XimPu7c][Measure the current by a spot welder]]

*** Machines
- [[https://www.alibaba.com/product-detail/-1600999217903.html][AwithZ P60F]]
*** Pens :ATTACH:
- [[https://www.aliexpress.com/item/1005005204122735.html][SUNKKO 73B Spot Welding Pen]]. S-75B has separate handheld probes(ie. not a pen style probe)
- AwithZ wp240 (maybe better than the Sunkko 73B)

It is annoying that AwithZ chose pure copper tips for a high current machine, but you can potentially swap them out for Aluminum Oxide Versions which should help.

#+CAPTION: Add heat shrink to insulate the two probes of the SUNKKO 73B pen
#+CAPTION: Without insulation I read that you loose current
[[attachment:sunkko-73b-insulation.jpg]]
*** Tips
Aluminum Oxide Copper vs Pure Copper on AwithZ Probes.
Aluminum Oxide is harder and has much better wear resistance. The other factor is the tip shape which is much thicker. More like a 3 mm diameter tip that tapers down to a 2 mm diameter ball shape. The thick tip allows high currents to pass through with less tip melting which causes sticking.
- [[https://www.aliexpress.com/item/1005002259341535.html][Welding Needle Aluminum Oxide 3mm Eccentric Rod]] ::
  Note you should cut off the 1.5 mm diameter section and then round off the tip till it has about a 2 mm diameter and smooth.
** Wires
[[https://www.amazon.com/dp/B08Q46JXBQ][BNTECHGO 12awg]], bntechgo is the best silicon bang for your buck.
...
[[attachment:battery-flexible-busbar.jpg]]
...
[[attachment:diy-7s-powerbank-inverter1.jpg]]

#+CAPTION: DIY 7s powerbank with 4000W inverter
[[attachment:diy-7s-powerbank-inverter2.jpg]]
...
[[attachment:How-to-Wire-Batteries-in-Series-and-Parallel.jpg]]
* fuses :ATTACH:
...
[[attachment:Choose_the_Fuse_Amperage.jpg]]
...
[[attachment:thin-fuse-wire-spotwelded.jpg]]

#+CAPTION: soldered fuse wire to solid bus bar
[[attachment:thin-fuse-wire-soldered.webp]]
...
[[attachment:nickel-fuse-strip.jpg]]
...
* Chargers
** AliExpress
- [[https://www.aliexpress.com/item/1005002759424107.html][Adjustable charger, 0-120V, 0-25A]], €96 ::
  Between 0-60V, 0-50A. This model is Battis Power. There are probably multiple more less identical chargers
** DIY Emerson/Vertiv R48 rectifier

The Emerson R48 power supply can be [[https://endless-sphere.com/sphere/threads/rectifier-emerson-r48-3500e-3200e-mod-voltage-adjust-13-65v-to-53-9v.112293/][voltage adjusted by changing resistor values/using a potmeter]].
But to get fully CC/CV, it has to be [[https://endless-sphere.com/sphere/threads/emerson-vertiv-r48-series-can-programming.114785/][programmed using CANbus]].

It can deliver very high current. The connector PCB / adapter can be found on AliExpress. Search for
- R48-3000E3 connector adapter board

These are good
- R48-1000e3, 1000W max
- R48-2000e3, 2000W max
- R48-3000e3, 3000W max

Note that the *offline* Voltage span depends on the model/year.
- R48-2000e3 built 2020/2022 ::
  permanent/offline ~41–58.5 V. Also derates less than most at low voltage; reported ~35 A down to 20 V.
- R48-2000e3 pre-2020 ::
  Reported permanent/offline only 48–58 V;

*** Offline VS Online
Offline means stored/permanent. Online means temporary and expires after communication stops or after reboot. The thread repeatedly says online voltage/current must be resent, commonly within 30 seconds; some users send every 25 seconds, and for R48-4300E3 below 48 V one user says every ~5 seconds is safer. For dynamic charging control, use online commands. Use offline commands only as safe fallback defaults, because they are stored values and may take ~30–45 seconds to visibly apply. One later ESP32 implementation explicitly pauses readback while sending permanent commands because otherwise the permanent values may not get set.
*** CC/CV control strategy
Arduino/ESP32 + MCP2515/TJA1050 works.

Use this structure:
1. Startup
   - Set safe offline voltage/current values.
   - Set output on.
   - Set fan auto or full depending on cooling.
   - Set AC input current limit according to wall socket capacity.

2. CC phase
   - Set online voltage slightly above present battery voltage, or use staged ramping.
   - Set online current limit to desired charge current.
   - Repeat online voltage/current every 5–15 seconds.

3. CV phase
    - Set online voltage to final pack voltage distributed across modules.
    - Keep current limit active.
    - Stop when current tapers to your termination threshold.

4. Fault/failsafe
    - If CAN controller dies, the modules fall back to offline values.
    - Therefore offline values should be conservative, not maximum-risk values.

* Examples
** 6s6p, for SUP
#+CAPTION: 6s6p battery for SUP motor
[[attachment:6S6P-full-pack.jpg]]

#+CAPTION: Motor
[[attachment:sup-motor-4400W.jpg]]

#+CAPTION: Using a 3d printed fixture to weld nickel strips onto the copper sheet
[[attachment:6S6P--nickel-3dprinted-fixture.jpg]]

#+CAPTION: The cells are hold together with two 3d printed cell spacer, vaguely seen as black between the cells
[[attachment:6S6P-ir-measurement.jpg]]

#+CAPTION: 3d models of the cell spacer and weld fixture
[[attachment:6S6P-fixture-spacer-3dfusion.jpg]]
- [[attachment:6S6P 21700.step]]
- [[attachment:6S6P 21700.f3d]]
** 6s1p, for FPV drone, :ATTACH:

#+CAPTION: 6s1p FPV drone battery
[[attachment:6s1p-fpv-drone-liion.jpeg]]

#+CAPTION: Another drone battery
[[attachment:drone-battery.jpeg]]

** 20s10p, bolted copper lugs, for scooter :ATTACH:
[[https://www.dropbox.com/scl/fo/if5ix35e0bq9coujebvl9/AMgF015j8DWvPBxMq-XJ578?dl=0&e=1&rlkey=vtuzhy1p6w0f24xtuoxs5qbly][Link to higher res images]]

Around 120A continuous, 250A peak
- leads are crimped into copper lugs that are bolted onto extra copper bars
- important to keep all the main cables from the BMS and Positive terminal the same length. Here especially the three split cables.
- The wire from the BMS is AWG7, and split it into 3× AWG10.
- copper lugs (AliExpress: "SC Type SC6 SC10 SC16 SC25 Copper Lug")
- 2 mm copper plates. There is one plate on the bottom and one on the top with drilled holes through them (the copper pinched easily)

#+CAPTION: 20s10p
[[attachment:20s10p-full.jpeg]]

#+CAPTION: Wires are crimped to copper lugs and bolted to copper bars
[[attachment:20s10p-closeup-bolted-connections.jpeg]]

#+CAPTION: Closeup of the bolted connection
[[attachment:20s10p-closeup-bolted-connections2.jpeg]]

#+CAPTION: All wires connected
[[attachment:20s10p-all-connected.jpeg]]

#+CAPTION: BMS app shows battery stats
[[attachment:20s10p-bms-screenshot.jpeg]]

#+CAPTION: Battery and scooter
[[attachment:20s10p-case-scooter.jpeg]]
** 3s5p, ~12V, 21700 :ATTACH:
great for small engine or a jumper pack if you have good enough cells.
3d printed enclosure and cell spacers. [[https://makerworld.com/en/models/2074695-21700-12-6v-battery-case-and-cell-holder][stl]]

- 2 main posts on top and 2 4mm holes for separate charge wires
- 2xM3 5mm screws to hold the lid on, 2xM6 Nuts, 2xM6 Bolts for the battery posts.
- 3s BMS from AliExpress

#+CAPTION: 3s5p front
[[attachment:3s5p-welded1.jpeg]]

#+CAPTION: 3s5p side
[[attachment:3s5p-welded2.jpeg]]

#+CAPTION: 3s5p without lid
[[attachment:3s5p-enclosure.jpeg]]

#+CAPTION: 3s5p full enclosure
[[attachment:3s5p-finished.jpeg]]
** 16s12p, electric motorcycle :ATTACH:

Battery for Yamaha 125 DTLC.

- 16s12p, 0.2mm copper, 0.1mm nickel.
- Two part, connected through 6 copper strips at the bottom
- 25mm2 cable (4awg) discharge
- 2.5mm2 (14awg), 25A fuse, charge

From https://www.facebook.com/julien.menada/


*** battery
[[attachment:16s12p_1.jpeg]]
[[attachment:16s12p_2.jpeg]]
[[attachment:16s12p_3.jpeg]]
[[attachment:16s12p_4.jpeg]]
[[attachment:16s12p_5.jpeg]]

*** BMS :ATTACH:
[[attachment:16s12p_bms_1.jpeg]]
[[attachment:16s12p_bms_2.jpeg]]
[[attachment:16s12p_bms_3.jpeg]]

*** Case :ATTACH:
[[attachment:16s12p_case_1.jpeg]]
[[attachment:16s12p_case_2.jpeg]]
[[attachment:16s12p_case_3.jpeg]]
[[attachment:16s12p_case_4.jpeg]]
[[attachment:16s12p_case_5.jpeg]]
