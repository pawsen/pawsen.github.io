...
#+filetags: hacking spectogram
#+hugo_categories: it
#+hugo_auto_set_lastmod: t
#+hugo_publishdate: 2024-12-14
#+HUGO_CUSTOM_FRONT_MATTER: :summary "FE created a 'hacker school' and hid a challenge in the announcement poster. This is how the challenge can be solved"
