...
#+CAPTION: Bowline tie-in for mid-rope during glacier traver. From page 22 of the "Bowline analysis" paper on https://www.paci.com.au/knots.php
[[attachment:bowline-glacier-traverse-p22-bowline_analysis.jpg]]
* Tech tips
** anchor :ATTACH:
...
There are a lot of different images of anchor types in this addon to [[https://people.bath.ac.uk/dac33/high/6TheBelay.htm#belaysthatlargelydontusetherope][Advanced Multipitch Climbing, by David Coley and Andy Kirkpatrick]] ([[https://web.archive.org/web/20250717053118/https://people.bath.ac.uk/dac33/high/6TheBelay.htm#belaysthatlargelydontusetherope][archive]])
...
*** carabiner though overhand knot on dyneema sling :ATTACH:

Some people clip a carabiner into the knot after forming the overhand knot so as to make it easier to untie. This is very effective with thin dyneema slings.

This is potentially dangerous, in that, if someone in a hurry (or in the dark) thought the knot clip carabiner was a secure place to clip in and weighted it, the knot would fail once the main locker was recovered.
Accidents happen when the unplanned occurs. Systems should be easy to read and safe against the unexpected.

#+CAPTION: Insert a carabiner in the overhand knot to make it easier to release. Note the carabiner must not be loaded
[[attachment:overhand-carabiner-though.jpeg]]
...
** 3d printed :ATTACH:
- [[attachment:Grigri drill-free accessory.stl]]

*** Anti crossload :ATTACH:
- [[attachment:anticrossload.stl]]
- [[attachment:anti-crossload-strap.stl][anti-crossload-strap.stl]]
- [[attachment:anti-crossload-strap-short.stl][anti-crossload-strap-short.stl]]
...
[[attachment:SoftCinchGIF1.gif]]
**** diy :ATTACH:
Recommend TPU 85A filament.
- [[https://makerworld.com/en/models/2674964-backfeed-preventer][Steve Young, from facebook LRS group]] ::
  - V1, [[attachment:rope retainer v1 20251007.stl]]
  - V2, size has been slightly increased to fit most carabiners , [[attachment:rope+retainer+2+wide+type+.stl]]
- [[https://github.com/pawsen/3dmodels/tree/main/climbing/backfeed%20preventer][my version on Github]]
** ice :ATTACH:
...
** Dangerous stuff :ATTACH:


#+CAPTION: Quickdraw pinched on a bolt. The quickdraw is used on the second bolt, as part of the lower anchor.
[[attachment:second-bolt-clove-hitch-quickdraw.jpeg]]
** Examples

Colin Haley, LRS of winter mix route.
https://youtu.be/Fxltm25tgdQ

* Forces on climber, belayer and anchor :ATTACH:
From [[https://www.hownot2.com/post/climbing-science#c990e4_9baafdd0e10848cfbc376951dfcde834~mv2.png][hownot2]] and [[https://www.petzl.com/US/en/Sport/Forces-at-work-in-a-real-fall][Petzl dynamic test]]. Factor 1 fall,
|                 | anchor, kN | climber, kN | belayer, kN |
|-----------------+------------+-------------+-------------|
| hownot2         |          4 |         2.5 |           1 |
| petzl, factor 1 |          6 |           4 |           2 |
...
- 10% stretch at static 80kg
- 30% stretch at 6kN fall
*** semi Static
- 4% stretch at static 80kg
- 15% stretch at 6kN fall
...
#+end_quote
** stiffy/extendo AKA panic draw DIY :ATTACH:

#+caption: DIY panic draw, extended
[[attachment:panic-draw-diy-extended.jpeg]]
#+caption: DIY panic draw, folded
[[attachment:panic-draw-diy-folded.jpeg]]

- Used 13 mm Qiyun Dyneema flat webbing (or any other standard 60cm dyneema sling).
- Bought 12 mm x 2 mm fiberglass rods to fit inside.
- Avoid thicker rods; they are too stiff and hard to pack.
- Have the seller pre-cut the rods, since cutting fiberglass is difficult and can cause splinters.
- Actual 60 cm webbing length was about 59.5 cm.
- Rods were cut to 57 cm, leaving space for a quickdraw or loose carabiner.
  - MadRock Trigger Wire / Camp Nano 22
- Heat-shrink tubing search term: =anti-slip textured heat-shrink tubing=
- Choose tubing size based on your webbing.
- My tubing size:
  - 15 mm round diameter
  - 26 mm flattened width
  - Shrinks to 8 mm
- Final fit is very tight and secure.

Another way is to use the metal from a measuring tape and put the dyneema sling inside a 1" flat webbing and close ends with tape

#+CAPTION: Panic draw made from measuring tape and dyneema sling inside 1" webbing
[[attachment:panic-draw-diy-metal-ruler.jpeg]]
...
* Canyoning
- https://www.opencanyon.org/
- https://www.descente-canyon.com/
